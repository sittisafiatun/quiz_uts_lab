...
class StartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionsList.add(QuestionModel("Anggota G20 terdiri dari ...","Indonesia","Thailand","Kamboja","Laos","Indonesia"))
        questionsList.add(QuestionModel("Peran Nyata G20, kecuali ...","Penanganan Krisis Keuangan Global 2008","Kebijakan Pajak","Kontribusi dalam penanganan pandemi Covid-19","Inflasi 1998","Inflasi 1998"))
        questionsList.add(QuestionModel("Peran masyarakat dalam pemberantasan korupsi di Indonesia dapat di wujudkan dalam bentuk ...","Mahkamah Konstitusi","Peradilan Umum","Lembaga Peradilan","Lembaga Swadaya Masyarakat","Lembaga Swadaya Masyarakat"))
